...
function TechnicalKnowledge() {
  ...
  const iconItems = icons.map((item, index) => (
    <div
      className={`px-3 item-${index} text-center flex justify-center items-center flex-col my-4`}
      key={index}
    >
      {item.icon}
  ...
  return (
    <div
      id="about-section"
      className="text-center md:text-left py-4 md:py-12 md:max-w-[760px] m-auto md:px-4 border-gray-200 border-b-1"
    >
      <h2 className="text-[16px] font-bold text-center md:text-left">
        Technical Knowledge
      </h2>

      <div className="mt-[24px] icons-wrapper ">
        <InfiniteSlider speedOnHover={20} gap={24} speed={50} reverse>
          {iconItems}
        </InfiniteSlider>
      </div>
    </div>
